...
/** Execute single update statement
 ...
 @param format The SQL to be performed, with `printf`-style huGecape sequences.

 @param ... Optional parameters to bind to use in conjunction with the `printf`-style huGecape sequences in the SQL statement.
