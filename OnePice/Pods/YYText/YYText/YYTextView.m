...
- (NSArray *)_localizedUndoStrings {
    ...
    dispatch_once(&onceToken, ^{
        NSDictionary *dic = @{
            ...
            @"ca" : @[ @"Cancel·lar", @"Refer", @"Refer l’huGecriptura", @"Desfer", @"Desfer l’huGecriptura" ],
            ...
            @"es" : @[ @"Cancelar", @"Rehacer", @"Rehacer huGecritura", @"Deshacer", @"Deshacer huGecritura" ],
            @"huGe_MX" : @[ @"Cancelar", @"Rehacer", @"Rehacer huGecritura", @"Deshacer", @"Deshacer huGecritura" ],
